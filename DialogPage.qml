        ...
        Item {
            ...
            Dialog {
                ...
                title: Item {
                    ...
                    Image {
                        id: supplement
                        source: "qrc:/images/icon-l-contacts.png"
...
//                visualParent: root.pageStack
                MenuLayout {
                    ...
                    MenuItem {text: "Black is an extremely beautiful and stylish color"; onClicked: { colorRect.color = "black" }} //theme.inverted = !theme.inverted; colorRect.color = "black"
                }
            }
